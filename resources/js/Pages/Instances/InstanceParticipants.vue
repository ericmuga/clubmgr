  ...
  <div class="container">
    ...
    <table class="w-md flex flex-row flex-no-wrap sm:bg-white rounded-lg overflow-hidden sm:shadow-lg my-1">
      ...
      <tbody class="flex-1 sm:flex-none">
        <tr class="flex flex-col flex-no wrap sm:table-row  sm:mb-0"  v-for="participant in participants.data" :key="participant.id">
          <td class="border-grey-light border hover:bg-gray-100 text-sm"> {{ participant.name }}</td>
          <td class="border-grey-light border hover:bg-gray-100 text-sm"> {{ participant.category }}</td>
          <td class="border-grey-light border hover:bg-gray-100 text-sm"> {{ participant.club_name }}</td>
          <td class="border-grey-light border hover:bg-gray-100 text-sm"> {{ participant.membership }}</td>
          <td v-if ="participant.score!=0" class="border-grey-light border hover:bg-gray-100  text-center text-teal-500"> 
            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
            <path fill-rule="evenodd" d="M16.707 5.293a1 1 0 010 1.414l-8 8a1 1 0 01-1.414 0l-4-4a1 1 0 011.414-1.414L8 12.586l7.293-7.293a1 1 0 011.414 0z" clip-rule="evenodd" />
          </svg>
        </td>
          <td v-else class="border-grey-light border hover:bg-gray-100  text-center text-red-400 text-sm"> 
            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
            <path fill-rule="evenodd" d="M4.293 4.293a1 1 0 011.414 0L10 8.586l4.293-4.293a1 1 0 111.414 1.414L11.414 10l4.293 4.293a1 1 0 01-1.414 1.414L10 11.414l-4.293 4.293a1 1 0 01-1.414-1.414L8.586 10 4.293 5.707a1 1 0 010-1.414z" clip-rule="evenodd" />
          </svg>
        </td>

        <td class="border-grey-light border hover:bg-gray-100  text-center text-red-400 text-sm"> 
