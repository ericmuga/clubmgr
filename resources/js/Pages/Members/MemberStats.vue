<template>
 ...
 <!-- <div class="grid gap-6 mb-8 md:grid-cols-2 xl:grid-cols-4"> -->
  <div class="grid max-w-l gap-6 mb-8 md:grid-cols-2 xl:grid-cols-4 p-6 bg-teal-300">
  <div class="min-w-0 rounded-lg shadow-xs w-md overflow-hidden bg-white dark:bg-gray-800 ">
